...
#  MODEL ARCHITECTURE
# ================================================================
# Options for MODEL_ARCH:
#   "segformer"  — SegFormer-B0 encoder (mit_b0) + FPN decoder (recommended)
#   "unet"       — U-Net with a configurable encoder backbone
MODEL_ARCH = "segformer"

# Only used when MODEL_ARCH == "unet"
UNET_ENCODER = "efficientnet-b0"

IN_CHANNELS = 3              # RGB input
NUM_CLASSES = 1              # Binary segmentation (single sigmoid output)
...
#  TRAINING HYPERPARAMETERS
# ================================================================
BATCH_SIZE = 8               # Parfait pour M1/M2/M3
LEARNING_RATE = 1e-4
WEIGHT_DECAY = 1e-2          # Très bien pour contrer l'overfitting

# --- MODIFICATIONS MAJEURES ICI ---
NUM_EPOCHS = 20              # Entraînement long pour que le modèle apprenne les nuances et élimine les faux positifs
EARLY_STOPPING_PATIENCE = 3  # Tu peux le laisser à 3# ----------------------------------
