...
async def predict_slums(file: UploadFile = File(...)):
    ...
    # The new vectorize_mask directly returns the dictionary
    geojson_data = vectorize_mask(output_mask)
    ...
    return JSONResponse({
        ...
        "metadata": {
            ...
            "model_name": "Region-Aware MoE (3 Experts)",
            "architecture": f"SegFormer {getattr(config, 'BACKBONE', 'mit_b0')}"
        },
